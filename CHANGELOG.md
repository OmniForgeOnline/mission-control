...
- 4105cf2: Move ClickUp ticket sync onto the ClickUp connector, harden mobile catalog/settings layouts, and expand agent setup (models, CLI install/login, home onboarding).
